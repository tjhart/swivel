...
import swivel.model.matchers.ContentTypeMatcher;
import swivel.model.matchers.HeaderMatcher;
import swivel.model.matchers.ParameterMapMatcher;
import swivel.model.matchers.RemoteAddrMatcher;
import swivel.model.matchers.RequestMethodMatcher;
import swivel.model.matchers.RequestedURIPathMatcher;
...
import swivel.model.matchers.RequestMethodMatcher;
import swivel.model.matchers.RequestedURIPathMatcher;
import swivel.model.matchers.ScriptMatcher;
    ...
    protected Matcher<HttpServletRequest> buildOptionalMatcher(HttpServletRequest expectationRequest,
        ...
        try {
            ...
            if (json.containsKey(REMOTE_ADDR_KEY)) {
                ...
                result.add(CoreMatchers.anyOf(RemoteAddrMatcher.hasRemoteAddr(equalTo(remoteAddr)),
            ...
            if (json.containsKey(SCRIPT_KEY)) {
                result.add(ScriptMatcher.scriptMatches((String) json.get(SCRIPT_KEY)));
            }
